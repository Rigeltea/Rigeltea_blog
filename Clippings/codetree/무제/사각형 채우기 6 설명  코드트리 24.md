...
source: "https://www.codetree.ai/ko/trails/complete/curated-cards/intro-lower-upper/introduction"
author:
published:
created: 2026-08-30
...
만약 내가 찾는 값 target이 배열에 여러 개 있다면, 이진탐색을 돌렸을 때 어떤 위치가 나오게 될지는 아무도 모릅니다. 이런 경우에 보통 사용하는 것이 Lower Bound 입니다.

![](https://contents.codetree.ai/problems/500/images/introductions-c07e9961-d8b3-416a-a027-22027ce7ec42.svg)

**Lower Bound는 원하는 값 target 이상의 값이 최초로 나오는 위치를 의미합니다.** 이는 바꿔말해 target보다 같거나 큰 원소의 위치들 중 가장 작은 값을 출력해야 한다는 것입니다. 따라서 작은 값을 구하기 위해 `min_idx` 라는 변수를 활용해 초기값으로 답이 될 수 없는 최댓값인 `arr.size` 를 넣어놓고 문제를 해결합니다. 다음과 같은 형태가 될 것입니다.
...
Upper Bound는 원하는 값 target을 초과하는 값이 최초로 나오는 위치를 의미합니다.

![](https://contents.codetree.ai/problems/500/images/introductions-b9cdc890-4d9a-4d16-8ba9-b72fba12ab76.svg)
...
![](https://contents.codetree.ai/problems/500/images/introductions-2cae3411-ebdd-4e6a-8ee3-0945b935a00b.svg)

## Custom Bound

target보다 같거나 작은 숫자들이 있는 위치 중 가장 큰 위치를 구하는 함수는 어떻게 작성해 볼 수 있을까요?

![](https://contents.codetree.ai/problems/500/images/introductions-f63b6457-9e3e-420f-9b88-79562bb903b9.svg)
